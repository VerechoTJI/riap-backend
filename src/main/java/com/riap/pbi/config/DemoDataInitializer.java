    ...
    public void run(String... args) {
        ...
        listingRepo.save(ListingEntity.builder()
                ...
                .feeDisclosure(FeeDisclosure.builder()
                        ...
                        .build())
                .landlordId(landlordId).city("台北市").district("大安區")
        ...
        listingRepo.save(ListingEntity.builder()
                ...
                .feeDisclosure(FeeDisclosure.builder()
                        ...
                        .build())
                .landlordId(landlordId).city("新北市").district("板橋區")
        ...
        listingRepo.save(ListingEntity.builder()
                ...
                .feeDisclosure(FeeDisclosure.builder()
                        ...
                        .build())
                .landlordId(landlordId).city("台北市").district("信義區")
        ...
        listingRepo.save(ListingEntity.builder()
                ...
                .feeDisclosure(FeeDisclosure.builder()
                        ...
                        .build())
                .landlordId(landlordId).city("台中市").district("西區")
